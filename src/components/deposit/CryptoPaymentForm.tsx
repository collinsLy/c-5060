  ...
  return (
    <div className="grid gap-2">
      <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-md text-blue-800 text-xs flex items-start gap-2">
        ...
        <p>Cryptocurrency selection and wallet details will be collected securely on the Pesapal payment page. You'll be redirected after clicking "Deposit Funds".</p>
      </div>
